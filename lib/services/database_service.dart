...
import 'background_parse_service.dart';
...
class DatabaseService extends ChangeNotifier {
  ...
  DatabaseService._internal() {
    _initializeData();
    _bgParseService.addListener(notifyListeners);
    _bgParseService.startActiveUploadPolling();
  }
  ...
  // Background Parsing Delegation
  final BackgroundParseService _bgParseService = BackgroundParseService();

  String? get uploadFileName => _bgParseService.uploadFileName;
  set uploadFileName(String? value) => _bgParseService.uploadFileName = value;

  bool get isParsing => _bgParseService.isParsing;
  set isParsing(bool value) => _bgParseService.isParsing = value;

  double get parsingProgress => _bgParseService.parsingProgress;
  set parsingProgress(double value) => _bgParseService.parsingProgress = value;

  bool get parsingComplete => _bgParseService.parsingComplete;
  set parsingComplete(bool value) => _bgParseService.parsingComplete = value;

  int get parsedRowsScanned => _bgParseService.parsedRowsScanned;
  set parsedRowsScanned(int value) => _bgParseService.parsedRowsScanned = value;

  int get parsedRowsSkipped => _bgParseService.parsedRowsSkipped;
  set parsedRowsSkipped(int value) => _bgParseService.parsedRowsSkipped = value;

  String get parsingProgressMessage => _bgParseService.parsingProgressMessage;
  set parsingProgressMessage(String value) => _bgParseService.parsingProgressMessage = value;

  List<Map<String, dynamic>> get parsedRecords => _bgParseService.parsedRecords;

  bool get isPasswordProtectedFile => _bgParseService.isPasswordProtectedFile;
  set isPasswordProtectedFile(bool value) => _bgParseService.isPasswordProtectedFile = value;

  Uint8List? get pendingBytesToDecrypt => _bgParseService.pendingBytesToDecrypt;
  set pendingBytesToDecrypt(Uint8List? value) => _bgParseService.pendingBytesToDecrypt = value;

  String? get pendingFileNameToDecrypt => _bgParseService.pendingFileNameToDecrypt;
  set pendingFileNameToDecrypt(String? value) => _bgParseService.pendingFileNameToDecrypt = value;

  String? get pendingFilePathToDecrypt => _bgParseService.pendingFilePathToDecrypt;
  set pendingFilePathToDecrypt(String? value) => _bgParseService.pendingFilePathToDecrypt = value;

  String? get passwordError => _bgParseService.passwordError;
  set passwordError(String? value) => _bgParseService.passwordError = value;

  bool get isCommittingUpload => _bgParseService.isCommittingUpload;
  set isCommittingUpload(bool value) => _bgParseService.isCommittingUpload = value;

  double get commitUploadProgress => _bgParseService.commitUploadProgress;
  set commitUploadProgress(double value) => _bgParseService.commitUploadProgress = value;

  String? get commitUploadError => _bgParseService.commitUploadError;
  set commitUploadError(String? value) => _bgParseService.commitUploadError = value;

  bool get commitUploadComplete => _bgParseService.commitUploadComplete;
  set commitUploadComplete(bool value) => _bgParseService.commitUploadComplete = value;

  String? get commitUploadStatusMessage => _bgParseService.commitUploadStatusMessage;
  set commitUploadStatusMessage(String? value) => _bgParseService.commitUploadStatusMessage = value;
  ...
  void startParsingExcel({
    ...
    _bgParseService.startParsingExcel(
      fileName: fileName,
      filePath: filePath,
      bytes: bytes,
      password: password,
  ...
  bool checkIsPasswordProtectedPublic(List<int> bytes) {
    return _bgParseService.checkIsPasswordProtectedPublic(bytes);
  }

  void setupDecryptPrompt(String fileName, Uint8List fileBytes) {
    _bgParseService.setupDecryptPrompt(fileName, fileBytes);
  }

  void cancelParsingAndReset() {
    _bgParseService.cancelParsingAndReset();
  }

  void resetParsedData() {
    _bgParseService.resetParsedData();
  }

  Future<void> loadParsedBackgroundRecords() {
    return _bgParseService.loadParsedBackgroundRecords();
  }
  ...
  Future<void> startBackgroundImport({
    ...
    return _bgParseService.startBackgroundImport(
      fileName: fileName,
      fileBytes: fileBytes,
    );
  }
  ...
  Future<void> startBackgroundParse({
    ...
    return _bgParseService.startBackgroundParse(
      fileName: fileName,
      filePath: filePath,
      bytes: bytes,
      password: password,
